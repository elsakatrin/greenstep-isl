      ...
      <Layout title="About">
        <div className={styles.aboutcontainer}>
          ...
          <p className={styles.bodytxt}>
            ...
            while ensuring a balance between economic growth, environmental care
            and social well-being. Environmental sustainability is the ability
            to maintain an ecological balance in our planet's natural
            environment and conserve natural resources. The foundations of
            environmental sustainability are: safeguarding water, saving energy,
            reducing waste, using recyclable packaging, limiting or eliminating
            the use of plastics, using sustainable transport, reusing paper and
